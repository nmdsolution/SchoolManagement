                        ...
                        @can('timetable-create')
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6 local-forms">
                                    ...
                                    <select required name="class_section_id" id="class_timetable_class_section" class="form-control select" style="width:100%;" tabindex="-1" aria-hidden="true">
                                        <option value="">{{__('select')}}</option>
                                        @foreach($class_sections as $section)
                                            <option value="{{$section->id}}" data-class="{{$section->class->id}}" data-section="{{$section->section->id}}">{{$section->full_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
