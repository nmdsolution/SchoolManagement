                        ...
                        <form class="pt-3 add-topic-form" id="create-form" action="{{ route('lesson-topic.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-3 local-forms">
                                    ...
                                    <select required name="subject_id" id="subject_id" class="subject_id form-control">
                                ...
                                <div class="form-group col-sm-12 col-md-12 local-forms">
                                    ...
                                    <textarea id="description" name="description"
                                              placeholder="{{ __('topic_description') }}"
                            ...
                            <div class="form-group">
                                <div class="row file_type_div" id="file_type_div">
                                    ...
                                    <div class="form-group col-md-3 local-forms" id="file_name_div"
                                         style="display: none">
                                    ...
                                    <div class="form-group col-md-3 local-forms" id="file_thumbnail_div"
                                         style="display: none">
                                    ...
                                    <div class="form-group col-md-3 local-forms" id="file_link_div"
                                         style="display: none">
                    ...
                    <div class="card-body">
                        ...
                        <div id="toolbar">
                            <div class="row">
                                ...
                                <div class="mb-4 col-sm-12 col-md-2 local-forms">
                                ...
                                <div class="mb-4 col-sm-12 col-md-4 local-forms">
                                    <label for="">{{ __('lesson') }}</label>
                        ...
                        @php
                            ...
                            $columns = [
                                ...
                                trans('subject') => ['data-field' => 'lesson_name', 'data-sortable' => true],
                                trans('lesson') => ['data-field' => 'lesson_name', 'data-sortable' => true],
                                trans('file') => ['data-field' => 'file', 'data-formatter' => 'fileFormatter', 'data-sortable' => true],
                            ];
                            $actionColumn = [
                                'editButton' => Auth::user()->can('topic-edit') ? ['url' => url('lesson-topic')] : false,
                                'deleteButton' => Auth::user()->can('topic-delete') ? ['url' => url('lesson-topic')] : false,
                                'data-events' => 'topicEvents',
                            ];
                        @endphp
                        <x-bootstrap-table :url=$url :columns=$columns :actionColumn=$actionColumn
                                           queryParams="CreateTopicQueryParams"></x-bootstrap-table>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="pt-3 edit-topic-form" id="edit-form" action="{{ url('lesson-topic') }}"
                            ...
                            <div class="modal-body">
                                ...
                                {{--                                                class="form-control file_type" style="pointer-events: none">--}}
                                {{--                                            <option value="">--{{ __('select') }}--</option>--}}
                                {{--                                            <option value="file_upload">{{ __('file_upload') }}</option>--}}
                                {{--                                            <option value="youtube_link">{{ __('youtube_link') }}</option>--}}
                                {{--                                            <option value="video_upload">{{ __('video_upload') }}</option>--}}
                                ...
                                {{--                                        <label>{{ __('file_upload') }} <span class="text-danger">*</span></label>--}}
                                {{--                                        <input type="file" name="edit_file[0][file]" class="form-control"--}}
                                {{--                                               placeholder="">--}}
                                ...
                                <div>
                                    <div class="form-group pl-0 mt-4">
                                        <button type="button" class="col-md-3 btn btn-inverse-success add-lesson-file">
...
@section('script')
    <script>
        ...
        window.onload = $('#class_section_id').trigger('change');

        window.onload = $('#filter_center_id').trigger('change');
        window.onload = $('#filter_class_section').trigger('change');

        function editFileHTML() {
            return '<div class="row edit_file_type_div local-forms" id="edit_file_type_div">' +
                '<input type="hidden" id="edit_file_id" name="edit_file[0][id]"/>'
                + '<div class="form-group col-md-2">'
                + '<label>{{ __('type') }}</label>'
