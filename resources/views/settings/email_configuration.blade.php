                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-12 local-forms">
                                    ...
                                    <select required name="mail_mailer" value="{{env('MAIL_MAILER')}}" class="form-control select2" style="width:100%;" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option {{env('MAIL_MAILER')=='mailgun' ?'selected':''}} value="mailgun">
                                            Mailgun
                                        </option>
                                        <option {{env('MAIL_MAILER')=='sendmail' ?'selected':''}} value="sendmail">
                                            sendmail
                                        </option>
                                        <option {{env('MAIL_MAILER')=='postmark' ?'selected':''}} value="postmark">
                                            Postmark
                                        </option>
                                        <option {{env('MAIL_MAILER')=='amazon_ses' ?'selected':''}} value="amazon_ses">
                                            Amazon SES
                                        </option>
                                    </select>
                                </div>
                        ...
                        <form class="verify_email" action="{{route('setting.varify-email-config')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-px-md-5">
                                    <input class="btn btn-primary m-4" type="submit" value="Verify">
                                </div>
                            </div>
                        </form>
                    </div>
