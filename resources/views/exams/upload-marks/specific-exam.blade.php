...
@section('script')
    <script>
        ...
        $('#exam_id').on('change', function () {
            ...
            // let visibe_class_section = $(this).find('option:selected').data('class-section') + '';
            // visibe_class_section = visibe_class_section.split(",")
            //
            //
            // console.log(visibe_class_section);
            // $(visibe_class_section).each(function (index, element) {
            //     $('#class_section_id option[value=' + element + ']').show();
            // })
