                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="create-form pt-3" action="{{ url('announcement') }}" id="formdata" method="POST" novalidate="novalidate">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4">
                                        <div class="form-group files">
                                            ...
                                            <input name="file[]" multiple type="file" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-3 local-forms">
                                        ...
                                        <select name="set_data" id="set_data" class="form-control select2">
                                            ...
                                            @if (Auth::user()->hasRole('Teacher'))
                                                <option value="class_section">{{ __('class') . ' ' . __('section') }}
                                                </option>
                                            @else
                                    ...
                                    <div class="form-group col-sm-12 col-md-3 show_class_section_id">
                                        <div class="local-forms">
                                            ...
                                            <select name="class_section_id" id="class_section_id" class="class_section_id local-forms select form-control" style="width:100%;" tabindex="-1" aria-hidden="true">
                                                <option value="">{{ __('select') . ' ' . __('class_section') }}
                                                </option>
                                                @foreach ($class_section as $item)
                                                    <option value="{{ $item->id }}" data-class="{{ $item->class->id }}">
                                                        {{ $item->full_name}}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-12 col-md-3 show_class_section_id">
                                        <div class="local-forms">
                                ...
                                <input class="btn btn-primary mt-2" type="submit" value={{ __('submit') }}>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table table-striped table_list' id="table_list" data-toggle="table" data-url="{{ url('announcement', 1) }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200, All]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-fixed-columns="true" data-fixed-number="2" data-fixed-right-number="1" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="desc" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{ "fileName": "assignment-list-<?= date('d-m-y') ?>" ,"ignoreColumn":["operate"]}' data-query-params="CreateAssignmentSubmissionQueryParams" data-show-export="true">
                                    <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="assign" data-sortable="true">{{ __('assign_to') }}</th>
                                        ...
                                        <th scope="col" data-field="operate" data-sortable="false" data-events="announcementEvents">{{ __('action') }}</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
                ...
                <form id="formdata" class="editform" action="{{ url('announcement') }}" novalidate="novalidate">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-12 edit_show_class_section_id" id="class_section_id">

                                <label>{{ __('class_section') }}</label>
                                <select name="class_section_id" id="edit_class_section_id" class="form-control " style="width:100%;" data-dropdown-parent="#class_section_id" data-dropdown-parent="body" tabindex="-1" aria-hidden="true">
    ...
    <script>
        ...
        $('#edit_set_data').on('change', function (e, type_id) {
            ...
            if (data == 'class_section') {
                ...
                $('#edit_get_data').parent().show();
            } else {
                $('.edit_show_class_section_id').hide();
                $('#edit_get_data').parent().hide();
            }
            $.ajax({
                url: "{{ url('getAssignData') }}",
                type: "GET",
