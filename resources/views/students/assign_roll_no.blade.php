                    ...
                    <div class="card-body">
                        ...
                        <div id="toolbar" class="my-3">
                            <div class="row">
                                <div class="col-sm-12 col-md-3 mb-4 local-forms">
                                    ...
                                    <select name="filter_roll_number_class_section_id" id="filter_roll_number_class_section_id" class="form-control select">
                                ...
                                {{-- <div class="col-sm-12 col-md-3 mb-4 local-forms">
                                    ...
                                    <select name="sort_by" id="sort_by" class="form-control select">
                        ...
                        <form id="assign-roll-no-form" action="{{ route('students.store-roll-number') }}" method="post">
                            ...
                            <div class="text-center ">
                                <input class="btn btn-primary btn_generate_roll_number my-4" id="create-btn" type="submit" value={{ __('submit') }}>
                            </div>
                        </form>
                    </div>
                </div>
