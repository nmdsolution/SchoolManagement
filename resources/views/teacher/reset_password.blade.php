                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table table_list' id='table_list' data-toggle="table"
                                       data-url="{{ url('teacher/reset-password-list') }}" data-click-to-select="true"
