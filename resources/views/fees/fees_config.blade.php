                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-12" style="margin-top: 2rem">
                                <div class="row">
                                    <div class="form-group col-md-2 local-forms">
                                        ...
                                        <select required name="razorpay_status" id="razorpay_status" class="form-control select" style="width:100%;" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="form-group col-md-5 local-forms">
                            ...
                            <div class="col-lg-12" style="margin-top: 2rem">
                                <div class="row">
                                    <div class="form-group col-md-2 local-forms">
                                        <label>{{ __('status') }} <span class="text-danger">*</span></label>
                                        <select required name="stripe_status" id="stripe_status" class="form-control select" style="width:100%;" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 local-forms">
                                    ...
                                    <input type="text" name="fees_due_date" class="datetimepicker form-control" value="{{ isset($settings['fees_due_date']) ? $settings['fees_due_date'] : '' }}" placeholder="{{ __('date') }}" autocomplete="off">
                                ...
                                <div class="form-group col-md-4 local-forms">
                                    ...
                                    <input type="number" name="fees_due_charges" class="form-control" value="{{ isset($settings['fees_due_charges']) ? $settings['fees_due_charges'] : '' }}" id="fees_due_charges" placeholder="{{ __('due_charges') }}">
                                </div>
                                <div class="form-group col-md-2 local-forms">
