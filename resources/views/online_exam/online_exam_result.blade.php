                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="result-class-name" value="{{$online_exam->class_subject->class->name}}" placeholder="{{ __('class').' '.__('name') }}" class="form-control" readonly/>
                            </div>
                            <div class="form-group col-md-4">
