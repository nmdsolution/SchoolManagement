...
class OnlineExamQuestionController extends Controller {
    ...
    public function show($id, Request $request) {
        ...
        if (Auth::user()->teacher) {
            $sql->whereHas('class_subject', function ($q) {
                $q->whereIn('subject_id', Auth::user()->teacher->subjects->pluck('subject_id'));
            });
        }
        ...
        foreach ($res as $row) {
            ...
            $tempRow['question'] = '';
            $tempRow['center_id'] = $row->class_subject->subject->center_id;
