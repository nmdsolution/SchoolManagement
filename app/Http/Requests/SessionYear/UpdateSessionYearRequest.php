...
class UpdateSessionYearRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('session-year-edit');
    }

    public function rules(): array
    {
        return [
            'id' => 'required|exists:session_years,id',
            ...
            'installment_data.*.id' => 'nullable|exists:installment_fees,id',
            'installment_data.*.name' => 'required_if:fees_installment,1',
    ...
    {
        $this->merge([
            'fees_installment' => (bool) $this->fees_installment,
