...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Schema::create('online_exams', function (Blueprint $table) {
            ...
            $table->bigInteger('class_subject_id')->unsigned()->index()->nullable(true);
            $table->foreign('class_subject_id')->references('id')->on('class_subjects')->onDelete('cascade');

            $table->string('title', 128)->nullable(true);
            $table->bigInteger('exam_key')->nullable(true);
            $table->integer('duration')->comment('in minutes')->nullable(true);
            $table->dateTime('start_date')->nullable(true);
            $table->dateTime('end_date')->nullable(true);
            $table->bigInteger('session_year_id')->unsigned()->index()->nullable(true);
        ...
        // student answers for online exam table
