...
class DummyDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Students::upsert($student, ['id'], ['user_id', 'class_section_id', 'admission_no', 'roll_number', 'caste', 'religion', 'admission_date', 'blood_group', 'height', 'weight', 'father_id', 'mother_id', 'guardian_id',]);
    }
}
